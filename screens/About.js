...
const AboutScreen = () => {
  return (
    <ScrollView style={styles.main}>
      ...
      <Text
        style={styles.link}
        onPress={() => Linking.openURL("https://github.com/TheMITTech/shakespeare/")}
      >
       https://github.com/TheMITTech/shakespeare/
      </Text>
      <Text style={styles.header}>
        Permissions to use MIT Shakespeare
      </Text>
      <Text style={styles.description}>
      ...
      <Text style={styles.description}>Quizzes questions and answers' content were generated by AI</Text>
    </ScrollView>
  );
};
